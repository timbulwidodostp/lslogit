...
{title:Examples}
{pstd}
{cmd:import excel "https://raw.githubusercontent.com/timbulwidodostp/lslogit/main/lslogit/lslogit.xlsx", sheet("Sheet1") firstrow clear}{p_end}
{pstd}
{cmd:lslogit choice, group(id) c(insurance) l(premium) boxcox cx(income deductible) lx1(income deductible)}{p_end}
...
{pstd}
{cmd:lslogit} was written by Timbul Widodo ({browse "mailto:bisnis.blog1976@gmail.com":bisnis.blog1976@gmail.com}),
https://www.youtube.com/@amalsedekah/videos
